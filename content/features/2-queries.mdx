...
Parameters bassed as the second argument to `query()` will be converted to raw data types using the following rules:
...
Converted to a string that describes a Postgres array. Each array item is recurisvely converted using the rules described here.
